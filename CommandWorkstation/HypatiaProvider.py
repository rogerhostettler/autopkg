...
def _new_software_request(product_id, host_id=12345, os_name='Mac OS X', os_version=' 10.15.7',
                          os_image_version=' 16G29', software_version='0.0.0.0', software_language='DE'):
